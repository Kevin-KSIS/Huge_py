...
def orasco(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.orascomci.com/index.php?id=subscribe "
        except:
            pass
...
def pint(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://info.pinpointe.com/subscribe-email-marketing-newsletter/"
        except:
            pass
...
def cofe(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.denniscoffey-thealbum.com/Re-Worked/index.html"
        except:
            pass
def steve(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://steveblank.com/about/"
        except:
            pass
...
def tattoo(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.tattoomike.com/mailinglist/public/index.php"
        except:
            pass
...
def proxy(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.topproxylist.net/subscribe.php#.T4GcjJ_k4xB"
        except:
            pass
...
def tips(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.addictivetips.com/mobile/enter-your-email-address-with-two-quick-taps-on-key-ios/"
        except:
            pass
def dora(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent withhttp://ci.mount-dora.fl.us/index.asp?Type=DYNAFORM&SEC={740FAD40-A0E1-483A-99C7-245CC47F1D71}"
        except:
            pass
...
def nin(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://dl.nin.com/theslip/signup"
        except:
            pass
def eib(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent withhttp://www.eib.org/infocentre/newsletters/subscribe.htm "
        except:
            pass
def mailman(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with https://mailman2.u.washington.edu/mailman/listinfo/plone_seattle"
        except:
            pass
def art(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent withhttp://www.arts.state.al.us/emailsubcribe.htm "
        except:
            pass
def designf(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://thedesignfiles.net/subscribe-via-email/ "
        except:
            pass
...
def wiliam(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://mathgradblog.williams.edu/subscribe-ams-grad-blog-email/"
        except:
            pass
...
def infacta(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with www.infacta.com/customers/"
        except:
            pass
def wagov(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://listserv.wa.gov/cgi-bin/"
        except:
            pass
def bbc(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://news.bbc.co.uk/2/hi/programmes/this_week/7595877.stm"
        except:
            pass
def uki(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.coe.uky.edu/cgi-bin/subscribe.pl"
        except:
            pass
def HMT(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.hmtrad.com/HMT/mailinglist.html"
        except:
            pass
...
def edge(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.edge.org/subscribe.html"
        except:
            pass
def frb(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.frbservices.org/HomePage/app/alertsubscribe.jsp"
        except:
            pass
def ars(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.ars.usda.gov/careers/docs.htm?docid=1358"
        except:
            pass
def nie(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.niemanlab.org/subscribe/"
        except:
            pass
def flori(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.myfloridaeh.com/radiation/Subscribe.htm"
        except:
            pass
...
def pirate(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.classic-pirates.com/subscribe"
        except:
            pass
def heroic(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.heroicstories.org/subscribe.html"
        except:
            pass
...
def garden(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.centralparkgardens.org/volunteer"
        except:
            pass
def lost(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://lostworlds.org/subscribe/"
        except:
            pass
...
def SAS(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://support.sas.com/techsup/news/tsnews.html"
        except:
            pass
def burk(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://blogs.berkeley.edu/subscribe-by-email/"
        except:
            pass
...
def warwick(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www2.warwick.ac.uk/knowledge/about/emails/subscription/"
        except:
            pass
def marine(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.marine.ie/home/aboutus/PressSubscribe.htm"
        except:
            pass
def soleil(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://alunajoy.com/maillist/?p=subscribe"
        except:
            pass
...
def council(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.pcouncil.org/currents/sign-up-for-newsletter-and-mailing-lists/"
        except:
            pass
def timedate(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.timeanddate.com/newsletter/subscribe.html"
        except:
            pass
def google(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.brandonbirding.co.uk/subscribe.asp"
        except:
            pass
def OCC(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.helpwithmybank.gov/subscribe/index-hwmb-subscribe.html"
        except:
            pass
def revenue(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.revenue.wi.gov/html/lists.html"
        except:
            pass
def royal(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.royalsociety.org.nz/news/subscribe/"
        except:
            pass
def com(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://dzogchencommunity.org/contact/subscribe-email-list.html"
        except:
            pass
def socialist(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://socialistworker.org/subscribe/email"
        except:
            pass
def windows(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.win7news.net/Subscribe/"
        except:
            pass
def toronto(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.toronto.ca/e-updates"
        except:
            pass
...
def cdc(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with http://www.cdc.gov/subscribe.html"
        except:
            pass
def msha(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://www.msha.gov/subscriptions/subscribe.aspx"
        except:
            pass
def hc(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://www.hc-sc.gc.ca/ahc-asc/media/sub-abonn/index-eng.php"
        except:
            pass
def bounty(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://www.naturalnews.com/ReaderRegistration1.asp"
        except:
            pass
def publis(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://www.publishersweekly.com/"
        except:
            pass
def IOSS(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://cmsmisc.indiatimes.com/"
        except:
            pass
...
def clickz(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://newsletters.clickz.com/s/"
        except:
            pass
def cream(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://newsletters.creamermedia.co.za/public/subscription"
        except:
            pass
def cali(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://www.cali.org/mailchimp/subscribe"
        except:
            pass
def etett(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://cmsmisc.indiatimes.com/mailregistration/register.aspx"
        except:
            pass
def myvoice(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://globalvoicesonline.org/subscribe/#mc_signup"
        except:
            pass
def core77(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://core77.cmail1.com/.aspx/s/80940/"
        except:
            pass
...
def mondediplo(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://mondediplo.com/"
        except:
            pass
...
def statee(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  http://www.newstatesman.com/?nocache=1"
        except:
            pass
def wordi(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  https://subscribe.wordpress.com/"
        except:
            pass
def wblizi(email):
    for a in xrange(10):
        try:
            ...
            print "New mail sent with  https://www.feedblitz.com/f/f.fbz?AddNewUserDirect"
        except:
            pass
